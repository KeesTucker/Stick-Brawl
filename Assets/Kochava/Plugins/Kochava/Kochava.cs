...
public class Kochava : MonoBehaviour {
	...
	private const bool isUnityStoreBuild = true;
	private const string sdkVersionNumber = "4.0.3";
	...
	private const string sdkBuildDate = "2019-06-18T21:51:33Z";
	...
	private static void iOSNativeStart(string appGuid, string partnerName, int logLevel, bool appLimitAdTracking, bool appLimitAdTrackingSet, bool sleep, bool retrieveAttribution, bool icm, bool icmManual, Dictionary<string, object> custom)
    {
		...
		{
			case 0:
				config ["logLevelEnum"] = "never";
				break;
			case 1:
				config ["logLevelEnum"] = "error";
				break;
			case 2:
				config ["logLevelEnum"] = "warn";
				break;
			case 3:
				config ["logLevelEnum"] = "info";
				break;
			case 4:
				config ["logLevelEnum"] = "debug";
				break;
			case 5:
				config ["logLevelEnum"] = "trace";
				break;
		}
		if(appLimitAdTrackingSet)
		{
